...
<template>
    ...
    <div id="ptsd">
            ...
            <b-row>
                <b-col md="12" style="margin-top:60px;margin-bottom:60px">
                    <div class="box">
                        <b-row>
                          <b-col md="12">
                            <h3 class="text-center m-t-0 m-b-0"><strong>DATA MASTER PTSD</strong></h3>
                          </b-col>
                        </b-row>
                        ...
                        <b-row class="m-t-15">
                            <b-col md="12">
                                <b-breadcrumb>
                                    ...
                                    <b-breadcrumb-item active>Data Master PTSD</b-breadcrumb-item>
                                </b-breadcrumb>
                            </b-col>
                        </b-row>
                                ...
                                <b-alert show variant="primary" class="m-b-0">
                                    ...
                                    <b-form-group
                                        ...
                                        <b-form-checkbox-group v-model="filterOn">
                                            <b-form-checkbox value="">Pertanyaan PTSD</b-form-checkbox>
        ...
        <b-modal id="modal-1" hide-footer centered title="TAMBAH DATA MASTER PTSD">
            <b-form class="bv-example-row">
                <b-form-group 
                label="Pertanyaan" 
                >
...
export default {
    ...
    methods: {
      info(item, index, button) {
        this.infoModal.title = `EDIT DATA MASTER PTSD`
