                  ...
                  <b-card no-body class="mb-1">
                    ...
                    >
                      <b-card-body>
                        ...
                        >
                          <b-form-select>
                            <b-form-select-option>Ya</b-form-select-option>
                            <b-form-select-option>Tidak</b-form-select-option>
                          </b-form-select>
                        </b-form-group>
                      </b-card-body>
                    </b-collapse>
...
export default {
  ...
  mounted() {
    ...
    axios
      ...
      .then((res) => {
        this.srqAns = res.data.respon;
        console.log(res, "jawaban srq");
      })
      .catch((err) => {
    ...
    axios
      .get(
        ipBackend + "/users/jawabanKecemasan",
        {
          id: this.idUser,
        },
        {
      ...
      .then((res) => {
        this.srqAns = res.data.respon;
        console.log(res, "jawaban kecemasan");
      })
      .catch((err) => {
        console.log(err, "ini error jawaban");
      });
    ...
    axios
      .get(
        ipBackend + "/users/jawabanDepresi",
        {
          id: this.idUser,
        },
        {
      ...
      .then((res) => {
        this.srqAns = res.data.respon;
        console.log(res, "jawaban depresi");
      })
      .catch((err) => {
        console.log(err, "ini error jawaban");
      });
    ...
    axios
      .get(
        ipBackend + "/users/jawabanGgnBelajar",
        {
          id: this.idUser,
        },
        {
      ...
      .then((res) => {
        this.srqAns = res.data.respon;
        console.log(res, "jawaban belajar");
      })
      .catch((err) => {
        console.log(err, "ini error jawaban");
      });
    ...
    axios
      .get(
        ipBackend + "/users/jawabanGgnEmosi",
        {
          id: this.idUser,
        },
        {
