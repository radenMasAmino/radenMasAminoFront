     ...
     <b-container class="bv-example-row">
       <b-row class="d-none d-sm-block">
         ...
         <b-col>
           <div class="partone">
             <div class="boxmenu">
               <router-link :to="'kecemasan'" style="text-decoration:none;color:#333">
               <center>
             ...
             <div class="boxmenu">
               <router-link :to="'depresi'" style="text-decoration:none;color:#333">
               <center>
                 <img src="../../assets/medical-record.png" style="height:100px">
                 <h5 class="m-t-15 m-b-0"><strong>MASTER</strong></h5>
             ...
             <div class="boxmenu">
               <router-link :to="'gangguanEmosi'" style="text-decoration:none;color:#333">
               <center>
                 <img src="../../assets/medical-record.png" style="height:100px">
                 <h5 class="m-t-15 m-b-0"><strong>MASTER</strong></h5>
             ...
             <div class="boxmenu">
                <router-link :to="'ptsd'" style="text-decoration:none;color:#333">
               <center>
                 <img src="../../assets/medical-record.png" style="height:100px">
                 <h5 class="m-t-15 m-b-0"><strong>MASTER</strong></h5>
             ...
             <div class="boxmenu">
               <router-link :to="'gangguanPenyesuaianBelajar'" style="text-decoration:none;color:#333">
               <center>
                 <img src="../../assets/medical-record.png" style="height:100px">
                 <h5 class="m-t-15 m-b-0"><strong>MASTER</strong></h5>
                 <h6 class="m-t-0 m-b-0"><strong>GANGGUAN PENYESUAIAN BELAJAR</strong></h6>
               </center>
                </router-link>
             </div>
